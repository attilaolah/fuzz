...
import (
	...
	"github.com/attilaolah/fuzz/tools/version_info"
)

// Location of the template file.
const tpl = "tools/write_me/write_me.tpl"
...
func main() {
	...
	if root == "" {
		...
		fmt.Println("Run this command using Bazel, i.e. like this: bazel run //tools/write_me")
		os.Exit(1)
	}
...
func url(path string) string {
	dir, _ := filepath.Split(path)
	return fmt.Sprintf("https://github.com/attilaolah/fuzz/blob/main/%s/BUILD.bazel", strings.Trim(dir, "/"))
}
